<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts ellipsis" v-if="info.supports" @click="ShowSup">
    ...
    <div class="activity-sheet" v-show="isShowSup">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close" @click="ShowSup">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
