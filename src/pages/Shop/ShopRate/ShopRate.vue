  ...
  <div class="ratings">
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        ...
        <div class="switch" :class="{on:filterText}" @click="toggleFilter">
...
export default {
    ...
    computed: {
        ...
        filterArr(){
            const {ratings,filterText,selectType} = this
            //
            let arr = []
            arr = ratings.filter(rate =>{
                //评价类型
                const {rateType,text} = rate
                return (selectType===2 || selectType===rateType) && (!filterText || text.length>0)
            })
            return arr
        }
    },
